var app = {
    ...
    inserir: function(){
        ...
        let telefone = document.getElementById("phoneInput").value;
        let origem = document.getElementById("origemInput").value;
        let data_contato = document.getElementById("dateInput").value;
